...
export default function AuthButton({
  ...
  const variants = {
    primary:
      "bg-[#4CAF50] px-6 py-3 text-white shadow-sm hover:bg-[#43A047] focus:ring-[#4CAF50]/40 active:scale-[0.98]",
    outline:
      "border border-gray-300 bg-white px-6 py-3 text-gray-700 shadow-sm hover:bg-gray-50 focus:ring-gray-300/40 active:scale-[0.98]",
    google:
      "border border-gray-300 bg-white px-6 py-3 text-gray-700 shadow-sm hover:bg-gray-50 focus:ring-gray-300/40 active:scale-[0.98]",
  };
